...
vim.o.tabstop = 4               -- tab charcter width
vim.o.softtabstop = 4           -- whitespace added or removed with tab or backspace
vim.o.shiftwidth = 4            -- whitespace used for one level of indentation
